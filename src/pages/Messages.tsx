    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-4 sm:py-8">
      <div className="container mx-auto px-3 sm:px-4 max-w-4xl">
        ...
        <div className="mb-4 sm:mb-8">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-white/80 mt-0.5 sm:mt-1 text-xs sm:text-base">Your conversations with sellers and support</p>
              </div>
            </div>
          </div>
        </div>
